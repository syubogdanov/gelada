...
errors::rapidjson::RapidjsonError::RapidjsonError(const std::string& detail)
    : std::runtime_error::runtime_error(detail) {}

errors::rapidjson::MismatchedSchemaError::MismatchedSchemaError(void)
    : errors::rapidjson::RapidjsonError::RapidjsonError(
